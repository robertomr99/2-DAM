...
public class FrmPrincipal extends JFrame {
	...
	public FrmPrincipal() {
		...
		setIconImage(Toolkit.getDefaultToolkit().createImage("Image/tic-tac-toe.png"));
		...
		lblPos1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ctrl.CtrlFrmPrincipal.contadorFichas() != 6) {
					ImageIcon image = new ImageIcon(new ImageIcon(ctrl.CtrlFrmPrincipal.colocarFichas(0, 0)).getImage()
		...
		lblPos2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ctrl.CtrlFrmPrincipal.contadorFichas() != 6) {
					ImageIcon image = new ImageIcon(new ImageIcon(ctrl.CtrlFrmPrincipal.colocarFichas(0, 1)).getImage()
							.getScaledInstance(128, 128, Image.SCALE_SMOOTH));
		...
		lblPos3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ctrl.CtrlFrmPrincipal.contadorFichas() != 6) {
					ImageIcon image = new ImageIcon(new ImageIcon(ctrl.CtrlFrmPrincipal.colocarFichas(0, 2)).getImage()
							.getScaledInstance(128, 128, Image.SCALE_SMOOTH));
		...
		lblPos4.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ctrl.CtrlFrmPrincipal.contadorFichas() != 6) {
					ImageIcon image = new ImageIcon(new ImageIcon(ctrl.CtrlFrmPrincipal.colocarFichas(1, 0)).getImage()
							.getScaledInstance(128, 128, Image.SCALE_SMOOTH));
		...
		lblPos5.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ctrl.CtrlFrmPrincipal.contadorFichas() != 6) {
					ImageIcon image = new ImageIcon(new ImageIcon(ctrl.CtrlFrmPrincipal.colocarFichas(1, 1)).getImage()
							.getScaledInstance(128, 128, Image.SCALE_SMOOTH));
		...
		lblPos6.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ctrl.CtrlFrmPrincipal.contadorFichas() != 6) {
					ImageIcon image = new ImageIcon(new ImageIcon(ctrl.CtrlFrmPrincipal.colocarFichas(1, 2)).getImage()
							.getScaledInstance(128, 128, Image.SCALE_SMOOTH));
		...
		lblPos7.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ctrl.CtrlFrmPrincipal.contadorFichas() != 6) {
					ImageIcon image = new ImageIcon(new ImageIcon(ctrl.CtrlFrmPrincipal.colocarFichas(2, 0)).getImage()
							.getScaledInstance(128, 128, Image.SCALE_SMOOTH));
		...
		lblPos8.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ctrl.CtrlFrmPrincipal.contadorFichas() != 6) {
					ImageIcon image = new ImageIcon(new ImageIcon(ctrl.CtrlFrmPrincipal.colocarFichas(2, 1)).getImage()
							.getScaledInstance(128, 128, Image.SCALE_SMOOTH));
		...
		lblPos9.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ctrl.CtrlFrmPrincipal.contadorFichas() != 6) {
					ImageIcon image = new ImageIcon(new ImageIcon(ctrl.CtrlFrmPrincipal.colocarFichas(2, 2)).getImage()
							.getScaledInstance(128, 128, Image.SCALE_SMOOTH));
